...
```
- Looks like the more immature whitefly there were, the more likely they were to die
...
- The interpretation of the $\hat{\beta}$ value (the coefficient of $x$) is in terms of _log odds_. A unit increase in $x$ gives a $\exp(\hat{\beta}) \approx 1.06$ times increase in the probability of a whitefly survivign
