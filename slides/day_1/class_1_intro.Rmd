...
## Data set 4: Geese isotopes again 
...
- Try to predict the behaviour of the response variable for missing or interpolated times
- Try and explain which factors are causing the time series to change
- Try to understand the underlying behaviour of the time series
