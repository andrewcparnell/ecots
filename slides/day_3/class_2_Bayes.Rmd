...
- A prior which is a strong constraint on the literature is called an _informative prior_
...
- Most people forget that choosing a likelihood probability distribution is exactly the same task
