...
$$y_t = \alpha + \beta_t \mbox{year}_t + \gamma_{1t} \mbox{Feb}_t + \gamma_{2t} \mbox{Mar}_t + \ldots + \gamma_{11,t} \mbox{Dec}_t + \epsilon_t$$
...
## Fit an ARIMA model to seasonal diffence

```{r}
Arima(CO2_diff, order = c(1, 0, 0))
```

## Forecasts from seasonally differenced series

```{r, fig.height = 5}
s_model_2 = Arima(CO2_diff, order = c(1, 0, 0))
plot(forecast(s_model_2, h = 24))
```

- Fiddly to back transform and not very helpful forecast
...
- This is a sARIMA$(1,0,0)(1,0,0)_{12}$ model
