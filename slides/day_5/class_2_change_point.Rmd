...
- We can make the state equation richer by making the relationship between the response and the latent time series richer
- We can make the evolution equation richer by including a more complex time series model, e.g. an OU process
- We can extend the model if the repsonse is multivariate, or allow the latent time series to be multivariate
